...
improvement\_eps       & real    & Ganho mínimo ($10^{-9}$) para aceitar melhoria na busca local. \\
parallel\_workers      & inteiro & Processos \emph{worker} efetivamente usados (1 $=$ serial). \\
